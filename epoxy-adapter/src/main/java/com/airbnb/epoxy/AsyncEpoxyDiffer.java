...
class AsyncEpoxyDiffer {
  ...
  public void submitList(@Nullable final List<? extends EpoxyModel<?>> newList) {
    ...
    if (previousList.size() > 0 && newList.size() > 0){
      Log.d("yyj4", "getChangePayload: old:"+ System.identityHashCode(previousList.get(0)) + "----new:" + System.identityHashCode(newList.get(0)));
    }
    ...
    executor.execute(new Runnable() {
      ...
      public void run() {
        ...
        Log.d("yyj", "executor run old:"+ System.identityHashCode(previousList.get(0)) + "----new:" + System.identityHashCode(newList.get(0)) + "--this:" + System.identityHashCode(this));
    ...
    MainThreadExecutor.ASYNC_INSTANCE.execute(new Runnable() {
      ...
      public void run() {
        ...
        if (result != null && dispatchResult) {
          Log.d("yyj", "onRunCompleted run" +"---new:" + System.identityHashCode(newList.get(0)) + "--this:" + System.identityHashCode(this));
  ...
  private static class DiffCallback extends DiffUtil.Callback {
    ...
    public Object getChangePayload(int oldItemPosition, int newItemPosition) {
      if (oldList.size() > 0 && newList.size() > 0){
        Log.d("yyj4", "getChangePayload: old:"+ System.identityHashCode(oldList.get(0)) + "----new:" + System.identityHashCode(newList.get(0)));
      }

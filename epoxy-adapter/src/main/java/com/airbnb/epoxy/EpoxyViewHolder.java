...
//    }
    ...
    Log.d("yyj2", "pre:" + System.identityHashCode(previouslyBoundModel) + " ---this:" + System.identityHashCode(epoxyModel) + " ---new:" + System.identityHashCode(model));
    if(previouslyBoundModel != epoxyModel){
      Log.e("yyj3", "bind: different, " + System.identityHashCode(previouslyBoundModel) + " --" + System.identityHashCode(epoxyModel));
    }
    Log.d("yyj", ".");
